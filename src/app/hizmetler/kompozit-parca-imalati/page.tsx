    ...
    <>
      ...
      <main style={{ background: '#0A1628', minHeight: '100vh' }}>
        ...
        <section className="relative h-[400px] overflow-hidden">
          <Image
            src="/images/fabrika-kareleri/hizmet-kompozit-otoklav-premium.png"
            alt="Kompozit parça üretimi"
            fill
            priority
            sizes="100vw"
          ...
          <div className="relative h-full flex flex-col justify-end pb-12">
            <div className="mx-auto max-w-7xl w-full px-4 sm:px-6 lg:px-8">
              ...
              <nav className="flex items-center gap-2 text-xs mb-6" style={{ color: 'rgba(248,249,250,0.5)', fontFamily: 'var(--font-body)' }}>
                ...
                <ChevronRight size={12} />
                <span style={{ color: '#D4A574' }}>Kompozit Parça İmalatı</span>
              </nav>
        ...
        <section className="py-16" style={{ background: '#0D0D0D' }}>
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              Malzeme &amp; Üretim <span style={{ color: '#D4A574' }}>Yöntemleri</span>
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {malzemeler.map((m) => (
                ...
                >
                  <m.icon size={28} style={{ color: '#D4A574', marginBottom: '16px' }} />
                  <h3
                  ...
                  {uygulamalar.map((u) => (
                    <li key={u} className="flex items-start gap-3">
                      <span
                        ...
                        style={{ color: 'rgba(212,165,116,0.7)', flexShrink: 0 }}
                      >
                        ›
                      </span>
                      <span
        ...
        >
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
            <h2
              ...
              style={{ color: '#F8F9FA', fontFamily: 'var(--font-heading)', letterSpacing: '0.06em' }}
            >
              Projenizi <span style={{ color: '#D4A574' }}>Birlikte Değerlendirelim</span>
            </h2>
            <p
