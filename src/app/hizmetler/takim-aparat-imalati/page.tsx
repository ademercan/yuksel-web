      ...
      <main style={{ background: '#0A1628', minHeight: '100vh' }}>
        ...
        >
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <nav className="flex items-center gap-2 text-xs mb-8" style={{ color: '#6C757D', fontFamily: 'var(--font-body)' }}>
              ...
              <ChevronRight size={12} />
              <span style={{ color: '#1E6BB5' }}>Takım &amp; Aparat İmalatı</span>
            </nav>
        ...
        <section className="py-16" style={{ background: '#0D0D0D' }}>
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              Takım &amp; Aparat <span style={{ color: '#1E6BB5' }}>Kategorileri</span>
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {kategoriler.map((k) => (
                ...
                >
                  <k.icon size={28} style={{ color: '#1E6BB5', marginBottom: '16px' }} />
                  <h3
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
              ...
              <div>
                ...
                <div
                  ...
                  style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(30,107,181,0.15)' }}
                >
                  <p className="text-xs tracking-widest uppercase mb-2" style={{ color: 'rgba(108,117,125,0.8)', fontFamily: 'var(--font-mono)' }}>
                    Kalıp Malzemeleri
                  </p>
        ...
        >
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
            <h2
              ...
              style={{ color: '#F8F9FA', fontFamily: 'var(--font-heading)', letterSpacing: '0.06em' }}
            >
              Takım İhtiyaçlarınız İçin <span style={{ color: '#1E6BB5' }}>Hemen Başlayalım</span>
            </h2>
            <p
